...
import nfem.visual
nfem.visual.fields2vtkfile(field_M0,'03_h_demag_exch_data%03d.vtk' % 0, mesh)
...
for tt in range(1,100):
    ...
    nfem.visual.fields2vtkfile([field_M,field_H_demag],'03_h_demag_exch_data%03d.vtk' % tt, mesh)
