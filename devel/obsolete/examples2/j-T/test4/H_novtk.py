...
for i in range(int(heating_time//time_step)+1):
    ...
    T3 = ocaml.probe_field(sundialsbuffer_final,"T",[+499.0, 10.0, 10.0])[0][1]
    ...
    f.write("%g\t%g\t%g\t%g\t%g\n" % (i*time_step*su.conversion_factor_of(SI(1,'s')).value,su.conversion_factor_of(SI(1,"K")).value*T0,su.conversion_factor_of(SI(1,"K")).value*T1,su.conversion_factor_of(SI(1,"K")).value*T2,su.conversion_factor_of(SI(1,"K")).value*T3))
