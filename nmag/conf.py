# -*- coding: utf-8 -*-
#
# NMAG User Manual documentation build configuration file, created by
# sphinx-quickstart on Sat Mar  5 00:10:37 2011.
#
...
extensions = ['sphinx.ext.pngmath', 'nmag']
...
project = u'NMAG User Manual'
copyright = u'2011, Hans Fangohr, Thomas Fischbacher, Matteo Franchin, Giuliano Bordignon, Jacek Generowicz, Andreas Knittel, Michael Walter, Maximilian Albert'
...
# template names.
html_additional_pages = {'index': "genindex.html"}
...
htmlhelp_basename = 'NMAGUserManualdoc'
...
latex_documents = [
  ('manual', 'NMAGUserManual.tex', u'NMAG User Manual Documentation',
   ur'Hans Fangohr, Thomas Fischbacher, Matteo Franchin\\ Giuliano Bordignon, Jacek Generowicz, Andreas Knittel\\ Michael Walter, Maximilian Albert', 'manual'),
]
...
man_pages = [
    ('manual', 'nmagusermanual', u'NMAG User Manual Documentation',
     [u'Hans Fangohr, Thomas Fischbacher, Matteo Franchin, Giuliano Bordignon, Jacek Generowicz, Andreas Knittel, Michael Walter, Maximilian Albert'], 1)
]

# This string will be included at the end of every source file that is
# read. This is the right place to add substitutions that should be
...
.. _University of Southampton: http://www.soton.ac.uk
"""
