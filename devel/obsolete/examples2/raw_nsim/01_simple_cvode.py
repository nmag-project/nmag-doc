# lialg_machine cvode demo script
...
mwe_Laplace_M=ocaml.mwe_sibling(mwe_M,"Laplace_M","Laplace_M/M",[("M","Laplace_M")])
...
lam=make_linalg_machine("lam_precession",
                        mwes=[mwe_M,mwe_dM,mwe_Laplace_M, mwe_H],
                        vectors=[lam_vector(name="M",mwe_name="M"),
                                 lam_vector(name="dM",mwe_name="dM"),
                                 lam_vector(name="Laplace_M",mwe_name="Laplace_M"),
                                 lam_vector(name="H",mwe_name="H"),
                                 ],
                        operators=[lam_operator("op_Laplace_M","Laplace_M","M",
                                                "<d/dxj Laplace_M(k)||d/dxj M(k)>, j:2,k:3"),
                                   ],
                        local_operations=[
                                          lam_local("set_dM",
                                                    field_mwes=["M","dM","H"],
                        ...
                        programs=[lam_program("rhs",
                                              ...
                                              commands=[["DISTRIB","arg_M","M"],
                                                        ["SITE-WISE","set_dM",["M","dM","H"],[],[]],
                                                        ["COLLECT","arg_dM","dM"]
                                                        ]),
                                  lam_program("execute_jplan",
                                              commands=[# will want to recompute H here later on!
                                                        ["JPLAN","jacobian",["M","H"]]
                                                        ]),
                                  ]
                        )
