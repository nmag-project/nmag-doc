...
recompute_conductivity=nfem2.site_wise_applicator(parameter_names=["H_x","H_y","sigma0","alpha"],
...
print "field_sigma contents:", nfem2.data_doftypes(field_sigma)

nfem2.plot_scalar_field(field_sigma,"sigma","/tmp/sigma.ps",
